...
<div class="container my-5 table-responsive cart-table">
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="row">
                            <tr>
                                ...
                                <td class="actions text-center" data-th="">
                                    <button class="btn btn-danger h-100 btn-red  remove-from-cart"><i class="las la-trash"></i></button>
                                </td>
                            </tr>
                        </div>
                        @endforeach
        ...
        <div class="col-12 mb-3 d-flex justify-content-end align-items-center">
            <button class="btn btn-success ml-2 text-white btn-theme px-5 checkout_btn">Checkout</button>
        </div>
        <?php }?>
    </div>
</div>

                ...
                @foreach($products as $product)
                    <div class="col-lg-3 col-md-4 col-6  mb-md-5 mb-4">
                        <div class="product-card card bs_1 h-100 border-0 br_10">
                            <a href="#" data-toggle="modal" data-target="#largeModal{{ $product->id  }}"><img class="card-img-top" src="{{ getImage('assets/images/frontend/product/'. $product->image, '350x260')}}" alt="Card image cap"></a>
                            <div class="card-body p-md-3 p-2">
                                <h5 class="card-title"><a href="#" data-toggle="modal" data-target="#largeModal{{ $product->id  }}" class="one_line">{{  $product->name }}</a></h5>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body"> 
                                    <img class="card-img-top" src="{{ getImage('assets/images/frontend/product/'. $product->image, '350x260')}}" alt="Card image cap">
                                </div>

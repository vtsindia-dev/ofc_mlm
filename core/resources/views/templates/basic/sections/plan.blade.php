@php
    ...
    $plans = App\Models\Plan::where('status', 1)->orderBy('id', 'DESC')->limit(3)->get();
@endphp
            ...
            @foreach($plans as $plan)
                <div class="col-md-6 col-lg-4">
                    <div class="plan-item">
                        ...
                        <ul class="plan-info">
                            <li>
                                <h6 class="direct">@lang('Direct Referral Bonus') : {{__($general->cur_sym)}}{{getAmount($plan->referral_bonus)}}</h6>
                            </li>
                        ...
                        <div class="total-return">
                            <h6 class="title">@lang('Total Level Commission') : {{getAmount($sumCommission)}} {{__($general->cur_text)}}</h6>

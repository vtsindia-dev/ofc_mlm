...
<head>
    ...
    <!--datatable-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/js/datatable/jquery.dataTables.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/js/datatable/buttons.dataTables.min.css')}}">
...
<script src="{{asset('assets/admin/js/datatable/dataTables.buttons.min.js')}}"></script>
